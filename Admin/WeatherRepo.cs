...
namespace WeatherASPNET
{
    public class WeatherRepo : IWeatherRepo
    {
        ...
        public Weather GetAPIResponse(string zipCode)
        {
            ...
            var apiCall = $"https://api.openweathermap.org/data/2.5/weather?q={zipCode}&units=metric&appid={_conn}";
            ...
            weather.MapsURL = $"https://www.google.com/maps/embed/v1/view?&key={weather.MapsKey}&center={weather.Coordinate.Latitude.ToString(CultureInfo.InvariantCulture).Replace(",", ".")},{weather.Coordinate.Longitude.ToString(CultureInfo.InvariantCulture).Replace(",", ".")}&zoom=9&maptype=satellite";
